...
def open_():
  ...
  root.title(f"Mu Own NotePad - {file_location}")
...
button_open=tk.Button(frame_button,text='Open File',command=open_)
button_open.grid(row=0,column=0,padx=5,pady=5)
button_save=tk.Button(frame_button,text='Save As',command=saving_)
